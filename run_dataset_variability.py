...
DEFAULT_OUTPUT_ROOT = ROOT / "dataset_variability_vqc_angle_runs"
...
if __name__ == "__main__":
    ...
    parser.add_argument("--n_test", type=int, default=1500)
    ...
    parser.add_argument(
        "--output_dir",
        default=None,
        help="Directory for this run's outputs. Defaults to a new timestamped run directory.",
    )
